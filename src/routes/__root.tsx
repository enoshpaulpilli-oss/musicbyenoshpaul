...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "MusicOS — A premium studio for musicians" },
      { name: "description", content: "Learn theory, explore harmony visually, practice, compose and analyze songs inside one beautifully designed workspace." },
